...
const DepositForm = () => {
    ...
    return (
      <div className="min-h-screen sm:w-2/5 mx-auto pt-28">
        ...
        <Toaster />
        <form onSubmit={handleRecharge} className="bg-white shadow-lg shadow-gray-400 rounded-lg p-6 w-[90%] max-w-md mx-auto">
